...
$(document).ready(function() {
    ...
    function scrollFunction() {
        if (
            ...
            $(".floating-wa").removeClass('d-none');
            
        } else {
            $(".site-header--sticky").removeClass("scrolling");
            $(".floating-wa").addClass('d-none');
        }
        if(
            document.documentElement.scrollTop < 50
        ){
            $(".site-header--sticky").addClass("dark-mode-texts");
        }else{
            $(".site-header--sticky").removeClass("dark-mode-texts");
        }
        ...
        $('section').each(function () {
            if($(this).position().top <= $(document).scrollTop() && ($(this).position().top + $(this).outerHeight()) > $(document).scrollTop()) {
                ...
                $(".nav-link-item").each(function() {
                    if($(sect).attr('id') != undefined){
                        $(sect).attr('id') == $(this).attr('href').replace('#', '') ? $(this).addClass('active') : $(this).removeClass('active')
                    }
                })
            }
        });
